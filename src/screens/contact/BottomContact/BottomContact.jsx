        ...
        <div className='bg-banner w-full py-10'>
            <div className='lg:flex w-[100%] sm:w-[90%] px-4 sm:px-0 mx-auto justify-between  py-10'>
                <div className='lg:w-[40%] w-full lg:py-6 flex lg:block justify-center items-center flex-col'>
                    <h1 className='xl:text-[55px] md:text-[40px] mb-4  text-[22px] leading-[60px]'>Call doesn't feel 
                        enough <span className='text-orange-500'>Visit Us</span></h1>
                    <p className=' py-2 md:text-[16px] text-center lg:text-left text-[14px]  font-semibold'>Lorem ipsum dolor, sit amet 
                    ...
                    <button className='bg-orange-500 duration-300 outline-none border-none rounded-2xl mt-3 py-2 px-3 font-[700] hover:bg-black  hover:text-white text-white'>Call Now</button>
                <div className='flex items-center gap-2 mt-3 text-[18px]'>
                        <BiMap/>
                        <p>Visit Us : <span className='text-orange-500 cursor-pointer'>(10 AM to 7 PM)</span> </p>
                </div>
                    <div className='flex items-center gap-2 mt-3  text-[16px]'>
                        <BsArrow90DegRight className='font-[800]'/>
                        <p className='font-bold'>B-136, B Block, Sector 2, Noida, Uttar Pradesh 201301</p>
                </div>
                </div>
